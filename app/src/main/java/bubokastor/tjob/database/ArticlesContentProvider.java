...
public class ArticlesContentProvider extends ContentProvider {
    private static final int ARTICLES_TABLE = 1;

    private static final UriMatcher URI_MATCHER;

    static {
        URI_MATCHER = new UriMatcher(UriMatcher.NO_MATCH);
        URI_MATCHER.addURI(SQLiteHelper.CONTENT_AUTHORITY, ArticlesTable.Requests.TABLE_NAME, ARTICLES_TABLE);
    }
    ...
    public String getType(@NonNull Uri uri) {
        switch (URI_MATCHER.match(uri)) {
            case ARTICLES_TABLE:
                return ArticlesTable.Requests.TABLE_NAME;
            default:
                return "";
        }
    }
